...
Wraps `.agents/cli/vault-sync`. This is **not** an rsync, classifier, or auto-router.
...
7. Run `.agents/bin/qmd update` after meaningful active-note changes.
...
`.agents/cli/vault-sync/README.md`.
