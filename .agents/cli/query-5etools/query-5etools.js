...
function getRepoRoot() {
  return path.resolve(
    process.env.TTRPG_5ETOOLS_DIR || path.join(process.cwd(), ".cache/vendor/5etools"),
  );
}
...
async function initialize5etools() {
  ...
  try {
    ...
    throw new Error(`No 5etools clone at ${repoRoot}. Run: .agents/harness vendor sync 5etools`);
  }
