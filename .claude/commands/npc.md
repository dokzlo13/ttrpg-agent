...
argument-hint: "[role, vibe, or location]"
model: sonnet
---

<!-- GENERATED by .agents/harness sync — do not edit. Source: .agents/prompts/npc.md -->


**Before doing anything else, load the `ttrpg-vault-authoring` skill and follow it.**
