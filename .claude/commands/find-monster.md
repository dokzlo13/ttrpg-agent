...
argument-hint: "[monster name]"
model: sonnet
---

<!-- GENERATED by .agents/harness sync — do not edit. Source: .agents/prompts/find-monster.md -->


**Before doing anything else, load the `ttrpg-rules-5etools-query` skill and follow it.**
