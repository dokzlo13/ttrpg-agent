...
argument-hint: "[monster name or statblock]"
model: opus
---

<!-- GENERATED by .agents/harness sync — do not edit. Source: .agents/prompts/foundry-monster.md -->


**Before doing anything else, load the `ttrpg-foundry-statblock-importer` skill and follow it.**
