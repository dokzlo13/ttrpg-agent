...
argument-hint: "[scene to describe]"
model: opus
---

<!-- GENERATED by .agents/harness sync — do not edit. Source: .agents/prompts/readaloud.md -->


**Before doing anything else, load the `ttrpg-create-readaloud` skill and follow it.**
