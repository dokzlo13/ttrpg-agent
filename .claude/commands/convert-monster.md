...
<!-- GENERATED by .agents/harness sync — do not edit. Source: .agents/prompts/convert-monster.md -->


**Before doing anything else, load the `ttrpg-rules-osr-to-5e` skill and follow it.**
